# Input/output wrecker

## Purpose

Wrecker which corresponds to the io.ReadWriter interface and provides completes read
 and/or write operations with an error when reaching the limits on completed calls
